...
local Window = Rayfield:CreateWindow({
   ...
   Theme = "Ocean", -- Color azul/cian estilo SuperNova
   DisableBuildWarnings = true,
   -- ESTO HACE QUE APAREZCA EL BOTÓN PARA MOVER/MINIMIZAR
...
-- NOTA PARA MOVIMIENTO EN MÓVIL:
-- Rayfield en Delta crea un pequeño botón circular en la pantalla.
-- Al tocar ese botón, puedes mover el menú o hacerlo pequeño.
