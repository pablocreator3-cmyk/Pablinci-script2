--[[
    PABLO_DTH 🗿 Hub v25 | Muscle Legends
    Optimizado para Delta Executor & GitHub Hosting
    Interfaz: Kavo UI (Blood Theme)
]]
...
-- --- FUNCIÓN DE SEGURIDAD PARA PERSONAJE ---
...
RebirthSection:NewTextBox("Meta de Rebirths", "Ej: 10 (0 para infinito)", function(txt)
...
RebirthSection:NewToggle("Activar Auto Rebirth", "Hace rebirth solo al tener fuerza", function(state)
    ...
    task.spawn(function()
        while getgenv().autoRebirth do
            ...
            -- Disparo de eventos de Rebirth
            pcall(function()
                game:GetService("ReplicatedStorage").rEvents.rebirthEvent:FireServer("rebirthRequest")
            end)
            
            rebirthesDone = rebirthesDone + 1
            task.wait(3) -- Tiempo seguro para procesar
        end
    end)
end)

-- --- CRÉDITOS ---
local CreditsSection = Window:NewTab("Info"):NewSection("Creado por PABLO_DTH 🗿")
