--[[
    PABLO_DTH 🗿 Hub v30 | Muscle Legends
    Librería: Rayfield (Optimización Delta Bypass)
    Color: DarkRed
]]

-- Forzar la carga de la librería con protección
local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Rayfield/main/source'))()

-- Configuración de la Ventana
local Window = Rayfield:CreateWindow({
   Name = "PABLO_DTH 🗿 | Muscle Legends",
   LoadingTitle = "PABLO_DTH Hub v30",
   LoadingSubtitle = "Bypass Delta Activo",
   ...
   Callback = function(Value)
      ...
      task.spawn(function()
         while getgenv().ghostKillGlobal do
            ...
            task.wait(0.6) -- Delay para evitar el kick del servidor
         end
      end)
   end,
})
