-- PABLO_DTH 🗿 Hub v24 | VERSIÓN ULTRA-LIGERA (ORION LIB)
...
-- TABS
local FarmTab = Window:MakeTab({ Name = "🏋️ Farm", Icon = "rbxassetid://4483345998", PremiumOnly = false })
local CombatTab = Window:MakeTab({ Name = "⚔️ Combate", Icon = "rbxassetid://4483345998", PremiumOnly = false })
local RebirthTab = Window:MakeTab({ Name = "♻️ Rebirth", Icon = "rbxassetid://4483345998", PremiumOnly = false })
