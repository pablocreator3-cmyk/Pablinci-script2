--[[
    PABLO_DTH 🗿 Hub v27 | Muscle Legends
    Librería: Rayfield (Optimización Forzada para Delta)
    Estado: Estable / GitHub Ready
]]

-- Protegemos la carga de Rayfield
local success, Rayfield = pcall(function()
    return loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Rayfield/main/source'))()
end)

if not success or not Rayfield then
    warn("PABLO_DTH Hub: Rayfield no pudo cargar. Reintentando...")
    return
end

local Window = Rayfield:CreateWindow({
   Name = "PABLO_DTH 🗿 | Muscle Legends",
   LoadingTitle = "PABLO_DTH Hub v27",
   LoadingSubtitle = "Optimizado para Delta",
